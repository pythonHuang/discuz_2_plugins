...
$_config['db']['1']['dbuser'] = 'dz34';
$_config['db']['1']['dbpw'] = 'dz34@02';
...
// --------------------------  CONFIG COOKIE  --------------------------- //
$_config['cookie']['cookiepre'] = 'jYQY_';
$_config['cookie']['cookiedomain'] = '';
$_config['cookie']['cookiepath'] = '/';

// -------------------------  CONFIG SECURITY  -------------------------- //
$_config['security']['authkey'] = 'd54f9c97a95f43f865782d3cdfeda90apYfhrRYIAFVb7Oudw8';
